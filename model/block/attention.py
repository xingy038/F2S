...
class CrossAttention(nn.Module):
    ...
    def _SDPA_attention(self, query, key, value, attention_mask):
        with nn.attention.sdpa_kernel([SDPBackend.FLASH_ATTENTION, SDPBackend.EFFICIENT_ATTENTION]):
            hidden_states = scaled_dot_product_attention(query, key, value, attention_mask)
