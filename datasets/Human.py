...
from .transform import Resize_Pad, NormalizeNormal, PrepareForNet, Jittering, Blurring, ShotNoise, JPEGCompression, NormalizeDepth
from .utils import read_raw_sample
...
class HumanDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        raw = read_raw_sample(self.mode, self.data_path, rel_path)
